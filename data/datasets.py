...
def binary_dataset(opt, root):
    ...
    # ✅ 添加调试信息
    # print(f"Classes found: {dset.classes}")
    # print(f"Class to idx: {dset.class_to_idx}")

    paths = [sample[0] for sample in dset.samples]
    return dset, paths


def is_valid_file_func(filename):
    extensions = (".jpg", ".jpeg", ".png", ".ppm", ".bmp", ".pgm", ".tif", ".tiff", ".webp", ".jfif")
